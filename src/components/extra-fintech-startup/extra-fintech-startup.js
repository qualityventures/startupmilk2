      ...
      <div className="efs__container">
        ...
        <div className="efs__box efs__box--big">
          ...
          <div className="efs__box-list">
            <div className="efs__box-desc">Onboarding<br />screens</div>
            <div className="efs__box-desc">Sign Up<br />&amp;Sign In</div>
            <div className="efs__box-desc">Bank<br />Cards</div>
        ...
        <div className="efs__box efs__box--1">
          ...
          <div className="efs__box-list">
            <div className="efs__box-desc">Symbol based<br />screens</div>
          </div>
        </div>
        ...
        <div className="efs__box efs__box--3">
          ...
          <div className="efs__box-list">
            <div className="efs__box-desc">Color<br />Schemes</div>
          </div>
        </div>
        ...
        <div className="efs__box efs__box--4">
          ...
          <div className="efs__box-list">
            <div className="efs__box-desc">Interface<br />icons</div>
          </div>
        </div>
        ...
        <div className="efs__box efs__box--5">
          ...
          <div className="efs__box-list">
            <div className="efs__box-desc">Vector<br />icons</div>
          </div>
        </div>
        ...
        <div className="efs__box efs__box--7">
          ...
          <div className="efs__box-list">
            <div className="efs__box-desc">Default<br />iOS font</div>
          </div>
        </div>
